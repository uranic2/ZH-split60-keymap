...
На самом деле, этот документ - моя попытка описать свою раскладку. Прежде чем начать делать свою раскладку, настоятельно рекомендую пару раз перечитать статью Ильи Шепрута https://optozorax.github.io/p/my-keyboard-layout/

Чем больше я работают за программируемой клавиатурой, тем больше идей из этой статьи я тащу в свою раскладку.

# Общие принципы проектирования 
Это раскладка - мой первый опыт с программируемыми клавиатурами, поэтому я сделал основную раскладку максимально похожую к тому, к чему я привык на стандартной клавиатуре (далее СК)

1. Базовые слои должны быть похожи на СК (стандартную клавиатуру). Поэтому за основу взяты QWERTY/ЙЦУКЕН.
...
6. Дополнительные символы (то что было в универсальной раскладке Широкова на <KBD>ALTGR</KBD>)
7. Нумпад
8. Пароли
11. Навигация между слоями

Начиная со второго слоя, левая верхняя клавиша (там где в базовом слое <KBD>ESC</KBD>) возвращает на "основной слой". Это на случай если я вдруг залутал между слоями.
...
Клавишам <KBD>ALT</KBD> и <KBD>SPACE</KBD> на левой руке совмещены  через TapDance 3. Пробел на левой руке мне нужен для комбинаций <KBD>CTRL</KBD> +<KBD>SPACE</KBD>
...
Цифры набирают обычным нажатием, символы через <KBD>SHIFT</KBD>,  как на обычной клавиатуре
...
Буквы "Ё"и "ъ" переехали на символьный слой. Букв "Б", "Ю" сдвинулись вправо, "Х" на одну позицию влево. 

Изменения все сделаны через свою раскладку в  WINDOWS. Возможно более лучший вариант был бы сделать это через программу  kanata, но честно говоря я ее еще не осилил🤷‍♂️

### Модификаторы на HOME ROW

Я пробовал разместить стандартные Win, ALT, CTRL, SHIFT  на долгое нажатие, но в итоге у меня остались только SHIFT (на обоих половинах на <KBD>F</KBD>, <KBD>J</KBD> ) и Win  на левой половине.  Т.е. долгое нажитие на клавишу <KBD>J</KBD> будет считаться как SHIFT.
...
* Вопросительный и восклицательный знаки находятся рядом под указательным пальцем. Вопросительный знак на home row, как более частно встречающийся
...
1. Раскладка Ильи Шепрута (рус)  (https://optozorax.github.io/p/my-keyboard-layout/) Огромная статья  очень качественная статья, где описан весь опыт. Очень многое мне знакомо и это отобразилось в моей раскладке. Рекомендую перечитывать время от времени.
